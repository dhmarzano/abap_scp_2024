CLASS zcl_insert_data_log_7626 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_insert_data_log_7626 IMPLEMENTATION.

  METHOD if_oo_adt_classrun~main.

    DATA: lt_travel   TYPE TABLE OF ztb_travel_7626,
          lt_booking  TYPE TABLE OF ztb_booking_7626,
          lt_book_sup TYPE TABLE OF ztb_bksuppl_7626.
    ...
    ztb_booking_7626,
    ztb_bksuppl_7626.
    INSERT: ztb_travel_7626 FROM TABLE @lt_travel,
    ztb_booking_7626 FROM TABLE @lt_booking,
    ztb_bksuppl_7626 FROM TABLE @lt_book_sup.
    out->write( 'DONE!' ).
