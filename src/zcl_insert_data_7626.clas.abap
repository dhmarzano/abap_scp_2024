CLASS zcl_insert_data_7626 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  PUBLIC SECTION.
...
CLASS zcl_insert_data_7626 IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.

*   Variables locales
    DATA: lt_acc_categ TYPE TABLE OF ztb_acc_categ,
          lt_catego    TYPE TABLE OF ztb_catego_7626,
          lt_clientes  TYPE TABLE OF ztb_clientes_762,
          lt_clnts_lib TYPE TABLE OF ztb_clnts_lib_76,
          lt_libros    TYPE TABLE OF ztb_libros_7626.
    ...
    DELETE FROM ztb_catego_7626.
    INSERT ztb_catego_7626 FROM TABLE @lt_catego.
    ...
    "Delete possible entries; insert new entries
    DELETE FROM ztb_clientes_762.
    INSERT ztb_clientes_762 FROM TABLE @lt_clientes.
    ...
    DELETE FROM ztb_clnts_lib_76.
    INSERT ztb_clnts_lib_76 FROM TABLE @lt_clnts_lib.
    ...
    DELETE FROM ztb_libros_7626.
    INSERT ztb_libros_7626 FROM TABLE @lt_libros.
